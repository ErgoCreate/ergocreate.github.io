...
```py
sk.RstDocument(size = "y35")
sk.RstDocument(size = "x120y35")
sk.RstDocument(size = "xchildreny40")
sk.RstDocument(size = "xchildrenychildren")
sk.RstDocument(size = "xchild_maxy40")
sk.RstDocument(size = "60")
sk.RstDocument(size = (120,35), size_hint = (None, None))
```
...
```py
sk.RstDocument(enable_events = True, on_event = 'width')
sk.RstDocument(enable_events = True, on_event = 'on_touch_down')
sk.RstDocument(enable_events = True, on_event = ['width','height','pos'])
sk.RstDocument(enable_events = True, on_event = {"size": lambda ins,v: print("size =",v)})
