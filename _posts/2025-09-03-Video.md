...
```py
sk.Video(size = "y35")
sk.Video(size = "x120y35")
sk.Video(size = "xchildreny40")
sk.Video(size = "xchildrenychildren")
sk.Video(size = "xchild_maxy40")
sk.Video(size = "60")
sk.Video(size = (120,35), size_hint = (None, None))
```
...
```py
sk.Video(enable_events = True, on_event = 'width')
sk.Video(enable_events = True, on_event = 'on_touch_down')
sk.Video(enable_events = True, on_event = ['width','height','pos'])
sk.Video(enable_events = True, on_event = {"size": lambda ins,v: print("size =",v)})
