...
---
`SimpleKivy.SimpleKivy.Camera0(k=None, **kwargs)`{: .python}


Creates a legacy (`kivy.uix.camera.Camera`) Camera widget dynamically with added functionalities.
...
```py
sk.Camera0(size = "y35")
sk.Camera0(size = "x120y35")
sk.Camera0(size = "xchildreny40")
sk.Camera0(size = "xchildrenychildren")
sk.Camera0(size = "xchild_maxy40")
sk.Camera0(size = "60")
sk.Camera0(size = (120,35), size_hint = (None, None))
```
...
```py
sk.Camera0(enable_events = True, on_event = 'width')
sk.Camera0(enable_events = True, on_event = 'on_touch_down')
sk.Camera0(enable_events = True, on_event = ['width','height','pos'])
sk.Camera0(enable_events = True, on_event = {"size": lambda ins,v: print("size =",v)})
