...
---
`SimpleKivy.SimpleKivy.FlatButton(text='flat_button', lcolor=[0.5, 0.5, 0.5, 1], bcolor_normal=[0.345, 0.345, 0.345, 0], bcolor_down=[0.2, 0.64, 0.8, 1], markup=True, focus_behavior=False, hover_highlight=False, enable_events=True, on_event='on_release', k=None, touchripple=False, **kwargs)`{: .python}
...
```py
sk.FlatButton(size = "y35")
sk.FlatButton(size = "x120y35")
sk.FlatButton(size = "xchildreny40")
sk.FlatButton(size = "xchildrenychildren")
sk.FlatButton(size = "xchild_maxy40")
sk.FlatButton(size = "60")
sk.FlatButton(size = (120,35), size_hint = (None, None))
```
...
```py
sk.FlatButton(enable_events = True, on_event = 'width')
sk.FlatButton(enable_events = True, on_event = 'on_touch_down')
sk.FlatButton(enable_events = True, on_event = ['width','height','pos'])
sk.FlatButton(enable_events = True, on_event = {"size": lambda ins,v: print("size =",v)})
...
`FlatButton` widget created dynamically.
...
`tooltip_text (StringProperty)`: Tooltip to be displayed when the mouse hovers over the `FlatButton` widget. Default is `""`.
