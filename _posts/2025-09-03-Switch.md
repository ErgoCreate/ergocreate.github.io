...
```py
sk.Switch(size = "y35")
sk.Switch(size = "x120y35")
sk.Switch(size = "xchildreny40")
sk.Switch(size = "xchildrenychildren")
sk.Switch(size = "xchild_maxy40")
sk.Switch(size = "60")
sk.Switch(size = (120,35), size_hint = (None, None))
```
...
```py
sk.Switch(enable_events = True, on_event = 'width')
sk.Switch(enable_events = True, on_event = 'on_touch_down')
sk.Switch(enable_events = True, on_event = ['width','height','pos'])
sk.Switch(enable_events = True, on_event = {"size": lambda ins,v: print("size =",v)})
