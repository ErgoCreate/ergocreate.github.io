...
---
`SimpleKivy.SimpleKivy.VideoPlayer(source='', k=None, **kwargs)`{: .python}


![VideoPlayer.png](assets/img/docs/VideoPlayer.png){: width="246" height="300" }

![VideoPlayer.2.png](assets/img/docs/VideoPlayer.2.png){: width="246" height="300" }
...
```py
sk.VideoPlayer(size = "y35")
sk.VideoPlayer(size = "x120y35")
sk.VideoPlayer(size = "xchildreny40")
sk.VideoPlayer(size = "xchildrenychildren")
sk.VideoPlayer(size = "xchild_maxy40")
sk.VideoPlayer(size = "60")
sk.VideoPlayer(size = (120,35), size_hint = (None, None))
```
...
```py
sk.VideoPlayer(enable_events = True, on_event = 'width')
sk.VideoPlayer(enable_events = True, on_event = 'on_touch_down')
sk.VideoPlayer(enable_events = True, on_event = ['width','height','pos'])
sk.VideoPlayer(enable_events = True, on_event = {"size": lambda ins,v: print("size =",v)})
