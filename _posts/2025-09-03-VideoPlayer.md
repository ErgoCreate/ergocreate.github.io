...
```py
VideoPlayer(size = "x120y35")
VideoPlayer(size = "xchildreny40")
VideoPlayer(size = "xchildrenychildren")
VideoPlayer(size = "xchild_maxy40")
VideoPlayer(size = "60")
```
...
```py
VideoPlayer(enable_events = True, on_event = 'width')
VideoPlayer(enable_events = True, on_event = 'on_touch_down')
VideoPlayer(enable_events = True, on_event = ['width','height','pos'])
```
